...
submission.to_csv(path_save + date + 'submission.csv', index=False)




# Train isolation forest model on train data
model = IsolationForest(n_estimators=200,random_state=12345,max_samples=2463,
...
submission.to_csv(path_save+'sjh8.csv', index=False)
