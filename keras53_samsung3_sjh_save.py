...
datasets_samsung = pd.read_csv(path + '현대자동차2.csv', index_col=0, encoding='cp949')
datasets_hyundai = pd.read_csv(path + '삼성전자 주가3.csv', index_col=0, encoding='cp949')
...
hist = model.fit([samsung_x_train_split, hyundai_x_train_split], [samsung_y_train_split, hyundai_y_train_split], epochs=10, batch_size=8, validation_split=0.2, callbacks=[es])
