...
from tensorflow.keras.layers import Dense, SimpleRNN,GRU,Bidirectional,LSTM
#1.데이터
...
# #2.모델구성
model = Sequential()
model.add(Bidirectional(SimpleRNN(30, return_sequences=True), input_shape=(3,1)))
model.add(LSTM(512))
...
#타임시리즈 시계열 데이터 1,2,3,4,5,6,7,8,9........................20