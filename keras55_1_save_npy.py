...
x_train = np.save(path + 'keras55_1_train_x.npy',arr=xy_train[0][0])
x_test = np.save(path + 'keras55_1_test_x.npy' ,arr=xy_train[0][0])
y_train = np.save(path + 'keras55_1_train_y.npy',arr=xy_train[0][0])
y_test = np.save(path + 'keras55_1_test_y.npy',arr=xy_train[0][0])
