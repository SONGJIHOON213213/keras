...
dense1 = Dense(3, activation='relu',name = 'stock1')(input1)
dense2 = Dense(4, activation='relu',name = 'stock2')(dense1)
dense3 = Dense(5, activation='relu',name = 'stock3')(dense2)
...
dense11 = Dense(5,name ='wearther1')(input2)
dense12 = Dense(3,name ='wearther2')(dense11)
dense13=  Dense(2,name ='wearther3')(dense12)
dense14 = Dense(4,name ='wearther4')(dense13)
...
dense12 = Dense(16,name ='wearther6')(dense11)
dense13=  Dense(16,name ='wearther7')(dense12)
dense14 = Dense(16,name ='wearther8')(dense13)
output3 = Dense(2,name ='output3')(dense14)
...
model = Model(inputs = [input1,input2,input3],outputs=last_output)#2개이상이라 리스트 구성
...
model.fit([x1_train,x2_train,x3_train],y_train,epochs=100, batch_size=60,verbose = 1 )
