...
dense1 = LSTM(90, activation='relu', name='sam1')(nerge1)
dense12 = Dense(90, name='huyn2')(dense1)
dense13 = Dense(10, name='huyn3')(dense12)
dense14 = Dense(20, name='huyn4')(dense13)
output1 = Dense(1, name='output1')(dense14)
